...
var testFiles = []struct {
	...
	// FAIL {"testdata/backslash.cool", []Token{STRINGLITERAL, STRINGLITERAL, STRINGLITERAL}},
	...
	// FAIL {"testdata/escapedquote.cool", []Token{INVALID_TOKEN}},
	// FAIL {"testdata/escapedunprintables.cool", []Token{STRINGLITERAL, STRINGLITERAL, STRINGLITERAL, STRINGLITERAL, STRINGLITERAL}},
	...
	// FAIL {"testdata/wq0607-c3.cool", []Token{STRINGLITERAL, STRINGLITERAL, INVALID_TOKEN, INVALID_TOKEN, STRINGLITERAL, INVALID_TOKEN, STRINGLITERAL, INVALID_TOKEN, STRINGLITERAL, STRINGLITERAL, INVALID_TOKEN, STRINGLITERAL, INVALID_TOKEN, INVALID_TOKEN}},
	// {"testdata/wq0607-c4.cool", []Token{}},
	// {"testdata/all_else_true.cl.cool", []Token{}},
}
...
var testSnippets = []struct {
	...
	{"InvalidChars", "of!#$%^&_>?`[]\\|if", []Token{OF, INVALID_TOKEN, INVALID_TOKEN, INVALID_TOKEN, INVALID_TOKEN, INVALID_TOKEN, INVALID_TOKEN, INVALID_TOKEN, INVALID_TOKEN, INVALID_TOKEN, INVALID_TOKEN, INVALID_TOKEN, INVALID_TOKEN, INVALID_TOKEN, INVALID_TOKEN, IF}},
}
